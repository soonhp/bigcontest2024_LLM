...
Example)
- user's question : 제주시 노형동에 있는 단품요리 전문점 중 이용건수가 상위 10%에 속하고 현지인 이용 비중이 가장 높은 3곳은?
...
- search result : [{{'s.MCT_NM': '블루메베이글노형점', 'avg_local_ratio': 0.82983683}}, {{'s.MCT_NM': '돈까스가있는풍경', 'avg_local_ratio': 0.823697359}}, {{'s.MCT_NM': '샤브마니아제주노형점', 'avg_local_ratio': 0.8234103085714286}}]

- answer : ## 🍽 제주시 노형동 단품요리 맛집 TOP 3! 현지인 추천 👍

"제주시 노형동에서 현지인들이 자주 찾는 **단품요리 전문점** 중 이용건수 상위 10%에 속하고 **현지인 이용 비중**이 높은 곳"을 찾았습니다!
...
제주도를 여행 중이시라면 **노형동에서 맛있는 단품요리**를 즐기고 싶다면, 이 3곳을 꼭 방문해 보세요! 후회하지 않을 거예요. 😊
